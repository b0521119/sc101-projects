...
class BreakoutGraphicsAdvanced:
    ...
    def __init__(self, ball_radius=BALL_RADIUS, paddle_width=PADDLE_WIDTH,
        ...
        self.window.add(self.ball,
                        x=(self.window_width - 2 * self.ball_radius) / 2, y=(self.window_height - 2 * self.ball_radius) / 2)
        ...
        # Draw score board
        self.score = 0
        self.score_board = GLabel('Score: ' + str(self.score), x=5, y=17)
        self.window.add(self.score_board)

        # Win label
        self.win = GLabel('YOU WIN!')
        self.win.font = '-15-bold'
        self.win.color = 'red'

        # Lose label
        self.lose = GLabel('YOU LOSE...HA!')
        self.lose.font = '-10-bold'
        self.lose.color = 'blue'
