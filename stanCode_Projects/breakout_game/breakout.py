...
def main():
    graphics = BreakoutGraphics(brick_rows=5, brick_cols=5)
    lives = NUM_LIVES
    count_brick = 0
    ...
    while True:
        ...
        if obj1 is not None:
            if obj1 is not graphics.paddle:
                ...
                count_brick += 1
                vy *= -1
            elif obj1 == graphics.paddle and vy >= 0:
                vy *= -1
            ...
            if obj2 is not graphics.paddle:
                ...
                count_brick += 1
                vy *= -1
            elif obj2 == graphics.paddle and vy >= 0:
                vy *= -1
            ...
            if obj3 is not graphics.paddle:
                ...
                count_brick += 1
                vy *= -1
            elif obj3 == graphics.paddle and vy >= 0:
                vy *= -1
            ...
            if obj4 is not graphics.paddle:
                ...
                count_brick += 1
                vy *= -1
            elif obj4 == graphics.paddle and vy >= 0:
                vy *= -1
